...
// module entry types (the factory, the renderable cast, the render order).
//
...
#error "FRAMELIFT_PACKAGE_METADATA_JSON must name the CMake-generated package metadata JSON (set by add_framelift_plugin)"
#endif
...
#define FRAMELIFT_DETAIL_PACKAGE_FACTORY(Table, Count)                                                                  \
    ...
    public:                                                                                                            \
        ...
        IRenderable* GetRenderable(const char* moduleId, IModule* module) noexcept override                            \
        {                                                                                                              \
            const ::framelift::detail::ModuleTableEntry* e = ::framelift::detail::FindModule((Table), (Count), moduleId); \
            return (e && e->render && e->getRenderable) ? e->getRenderable(module) : nullptr;                          \
        }                                                                                                              \
...
#define FRAMELIFT_MODULE_ENTRY(Type, ...)                                                                              \
    ...
    inline const ::framelift::detail::ModuleTableEntry kModuleTable[] = {                                              \
        {nullptr, &::framelift::detail::CreateModule<Type>, &::framelift::detail::GetRenderable<Type>, kDesc.renderOrder, \
         kDesc.render}};                                                                                               \
    }                                                                                                                  \
